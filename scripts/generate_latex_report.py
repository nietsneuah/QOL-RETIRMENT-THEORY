#!/usr/bin/env python3
"""
Generate professional LaTeX report for QOL Framework analysis.
"""
...
\\fancyhead[R]{{\\thepage}}
\\fancyfoot[C]{{Generated {report_date}}}
...
\\begin{{figure}}[H]
\\centering
\\includegraphics[width=\\textwidth]{{output/charts/comprehensive_qol_analysis.png}}
...
\\end{{document}}"""
    ...
    # Save LaTeX file
    with open("output/reports/qol_framework_comprehensive_report.tex", "w") as f:
        f.write(latex_content)
    
    print("📄 LaTeX report generated: output/reports/qol_framework_comprehensive_report.tex")
    print("💡 To compile to PDF, run: pdflatex qol_framework_comprehensive_report.tex")
